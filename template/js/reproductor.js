...
$(function () {
    ...
    if (iTotalCanciones > 0) {//clic en el boton play
    ...
    $('#btnSubirVolumen').on('click', function () {
        ...
        if (objReproductor.volume != 1)
            objReproductor.volume += 0.1;
    });
    ...
    $(objReproductor).on('error', function () {
        console.log('Se produjo un error en la reproducción!');
